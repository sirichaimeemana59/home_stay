...
(function(){
	...
	var each = helpers.each = function(loopable,callback,self){
		...
		inherits = helpers.inherits = function(extensions){
			//Basic javascript inheritance based on the model created in Backbone.js_
			var parent = this;
...
(function(){
	...
	Chart.Type.extend({
		...
		//Config is automatically merged by the core of Chart.js_, and is available at this.options
		initialize:  function(data){
