        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel-body search-form">
                    {!! Form::model($news,array('url' => array('/super_admin/news/update'),'class'=>'form-horizontal create-store-form','id'=>'form_add','method'=>'post','enctype'=>'multipart/form-data')) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="detail_th" class="sommernote">{!! $news->detail_th !!}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="detail_en" class="sommernote">{!! $news->detail_en !!}</textarea>
                        </div>
                    </div>
        ...
        $(document).ready(function() {
            ...
            $('body').on('click','.delete_photo',function(){
                ...
                swal({
                    ...
                    if (willDelete) {
                        setTimeout(function() {
                            $.post($('#root-url').val()+"/super_admin/list_news/delete_photo", {
                                id: id
                            }, function(e) {
                                swal("{!! trans('messages.delete_alert.success') !!}", {
                                    icon: "success",
                                }).then(function(){
                                    window.location.href =$('#root-url').val()+'/super_admin/list_news/form_edit/'+tran
                                });
                            });
                        }, 50);
                    } else {
