        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel-body search-form">
                    {!! Form::model(null,array('url' => array('/super_admin/list_travel/add_travel'),'class'=>'form-horizontal create-store-form','id'=>'form_add','method'=>'post','enctype'=>'multipart/form-data')) !!}
