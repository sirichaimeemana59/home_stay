...
{{--                            <li><a href="#">Menu 3</a></li>--}}
                        ...
                        <div class="tab-content clearfix">
                            <div class="tab-pane active" id="th">
                                <h3>{!! trans('messages.travel.name') !!} :</h3> <h4>{!! $travel->name_th !!}</h4>
                                <h3>{!! trans('messages.property.phone') !!} :</h3> <h4>{!! $travel->phone !!}</h4>
                                <h3>{!! trans('messages.property.location') !!} :</h3> <h4>{!! $travel->location !!}</h4>
                                <h3>{!! trans('messages.travel.detail') !!} :</h3> <h4>{!! $travel->detail_th !!}</h4>
                            </div>
                            <div class="tab-pane active_en" id="en">
                                <h3>{!! trans('messages.travel.name') !!} :</h3> <h4>{!! $travel->name_en !!}</h4>
                                <h3>{!! trans('messages.property.phone') !!} :</h3> <h4>{!! $travel->phone !!}</h4>
                                <h3>{!! trans('messages.property.location') !!} :</h3> <h4>{!! $travel->location !!}</h4>
                                <h3>{!! trans('messages.travel.detail') !!} :</h3> <h4>{!! $travel->detail_en !!}</h4>
                            </div>
                        </div>
                    </div>
                </div>
