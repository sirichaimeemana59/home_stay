@extends('home_admin_property.home_admin_property')
@section('content')
...
{{--                    <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>--}}
                    ...
                    <form method="POST" id="search-form" action="#" accept-charset="UTF-8" class="form-horizontal">
                        <div class="row">
                            <div class="col-sm-3 block-input">
                                <input class="form-control" size="25" placeholder="{!! trans('messages.home_stay.name') !!}" name="name">
                            </div>
    ...
    <div class="nav-tabs-custom panel-body">
        <div class="row" style="margin: 5px;">
            <div class="col-sm-12 text-right">
                <a href="{!! url('/admin_property/list_home_stay_property/create/form') !!}"><button class="btn btn-primary mt-2 mt-xl-0 text-right"><i class="fa fa-plus-circle"></i>  {!! trans('messages.home_stay.home_stay') !!}</button></a>
{{--                <button class="btn btn-primary mt-2 mt-xl-0 text-right add-property"><i class="fa fa-plus-circle"></i>  {!! trans('messages.home_stay.home_stay') !!}</button>--}}
        ...
        <div class="row panel-body">
            <div class="col-lg-12" id="landing-subject-list">
                @include('home_admin_property.room_in_home_stay.list_room_element')
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #9BA2AB;">
                    <h4 class="modal-title">{!! trans('messages.home_stay.home_stay') !!}</h4>
...
{{--                                </div>--}}
    ...
    <div class="modal fade" id="view-store" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #9BA2AB;">
                    <h4 class="modal-title" style="color: #bbbfc3;">{!! trans('messages.home_stay.home_stay') !!}</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="row">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.reset-s-btn').on('click',function () {
                ...
                //propertyPageSale (1);
                window.location.href =$('#root-url').val()+'/admin_property/list_home_stay_property';
            });
            function propertyPage (page) {
                ...
                $.ajax({
                    url: $('#root-url').val() + '/admin_property/list_home_stay_property',
                    method: 'post',
                    dataType: 'html',
                    data: data,
                    success: function (e) {
            ...
            $('body').on('click','.view',function(){
                ...
                $('.v-loading').show();
                $.ajax({
                    url:$('#root-url').val()+'/admin_property/list_home_stay_property/view',
                    method:'post',
                    dataType:'html',
                    data:({'id':id}),
                    success:function(e){
            ...
            $('body').on('click','.edit',function(){
                ...
                $('.v-loading1').show();
                $.ajax({
                    url:$('#root-url').val()+'/admin_home_stay/edit',
                    method:'post',
                    dataType:'html',
                    data:({'id':id}),
                    success:function(e){
            ...
            $('body').on('click','.delete-store',function(){
                ...
                swal({
                    ...
                    if (willDelete) {
                        setTimeout(function() {
                            $.post($('#root-url').val()+"/admin_property/list_home_stay_property/delete", {
                                id: id
                            }, function(e) {
