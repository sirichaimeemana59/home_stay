        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel-body search-form">
                    {!! Form::model(null,array('url' => array('/admin_property/list_home_stay_property/create'),'class'=>'form-horizontal create-store-form','id'=>'form_add','method'=>'post','enctype'=>'multipart/form-data')) !!}
