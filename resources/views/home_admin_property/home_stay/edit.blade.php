        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel-body">
                    <a href="{!! url(('/admin_property/list_home_stay_property')) !!}"><button type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Tooltip on top">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel-body search-form">
                    {!! Form::model($home,array('url' => array('/admin_property/list_home_stay_property/update'),'class'=>'form-horizontal create-store-form','id'=>'form_add','method'=>'post','enctype'=>'multipart/form-data')) !!}
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="hidden" name="id_hidden" value="{!! $home->id !!}">
                            <input type="hidden" name="id_hidden_property" value="{!! $home->property_id !!}">
                        </div>
                        ...
                        <table class="table itemTables" style="width: 100%">
                            ...
                            @foreach($home->join_transection as $key => $row)
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        <select name="data_[{!! $key !!}][type_id]" id="type_id" class="form-control" style="width:300px;">
                                            <option value="">{!! trans('messages.type') !!}</option>
                                            <option value="1" {!! $select1 !!}>Sweet</option>
                                            <option value="2" {!! $select2 !!}>Dulux</option>
        ...
        $(document).ready(function() {
            ...
            $('body').on('click','.delete-subject',function(){
                ...
                swal({
                    ...
                    if (willDelete) {
                        setTimeout(function() {
                            $.post($('#root-url').val()+"/admin_property/list_home_stay_property/delete_room", {
                                id: id
                            }, function(e) {
                                swal("{!! trans('messages.delete_alert.success') !!}", {
                                    icon: "success",
                                }).then(function(){
                                    window.location.href =$('#root-url').val()+'/admin_property/edit_home_stay/'+home_id
                                });
                            });
                        }, 50);
                    } else {
