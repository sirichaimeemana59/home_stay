        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel-body search-form">
                    {!! Form::model($home,array('url' => array('/admin_home_stay/update'),'class'=>'form-horizontal create-store-form','id'=>'form_add','method'=>'post','enctype'=>'multipart/form-data')) !!}
        ...
        $(document).ready(function() {
            ...
            $('body').on('click','.delete-subject',function(){
                ...
                swal({
                    ...
                    if (willDelete) {
                        setTimeout(function() {
                            $.post($('#root-url').val()+"/admin_home_stay/delete_room", {
                                id: id
                            }, function(e) {
                                swal("{!! trans('messages.delete_alert.success') !!}", {
                                    icon: "success",
                                }).then(function(){
                                    window.location.href =$('#root-url').val()+'/admin_home_stay/edit/'+home_id
                                });
                            });
                        }, 50);
                    } else {
