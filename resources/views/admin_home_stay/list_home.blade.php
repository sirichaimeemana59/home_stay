...
{{--                    <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>--}}
    ...
    <div class="nav-tabs-custom panel-body">
        <div class="row" style="margin: 5px;">
            <div class="col-sm-12 text-right">
                <a href="{!! url('admin_home_stay/create/form') !!}"><button class="btn btn-primary mt-2 mt-xl-0 text-right"><i class="fa fa-plus-circle"></i>  {!! trans('messages.home_stay.home_stay') !!}</button></a>
{{--                <button class="btn btn-primary mt-2 mt-xl-0 text-right add-property"><i class="fa fa-plus-circle"></i>  {!! trans('messages.home_stay.home_stay') !!}</button>--}}
        ...
        <div class="row panel-body">
            <div class="col-lg-12" id="landing-subject-list">
                @include('admin_home_stay.list_home_element')
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.reset-s-btn').on('click',function () {
                ...
                //propertyPageSale (1);
                window.location.href =$('#root-url').val()+'/admin_home_stay';
            });
            function propertyPage (page) {
                ...
                $.ajax({
                    url: $('#root-url').val() + '/admin_home_stay',
                    method: 'post',
                    dataType: 'html',
                    data: data,
                    success: function (e) {
            ...
            $('body').on('click','.view',function(){
                ...
                $('.v-loading').show();
                $.ajax({
                    url:$('#root-url').val()+'/admin_home_stay/view',
                    method:'post',
                    dataType:'html',
                    data:({'id':id}),
                    success:function(e){
            ...
            $('body').on('click','.delete-store',function(){
                ...
                swal({
                    ...
                    if (willDelete) {
                        setTimeout(function() {
                            $.post($('#root-url').val()+"/admin_home_stay/delete", {
                                id: id
                            }, function(e) {
